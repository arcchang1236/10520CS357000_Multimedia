...
% Result images
imwrite(sum(abs(full_a-T), 3), 'Result\1a_full_b8_p8.jpg')
imwrite(sum(abs(full_b-T), 3), 'Result\1a_full_b8_p16.jpg')
imwrite(sum(abs(full_c-T), 3), 'Result\1a_full_b16_p8.jpg')
imwrite(sum(abs(full_d-T), 3), 'Result\1a_full_b16_p16.jpg')

imwrite(sum(abs(log_a-T), 3), 'Result\1a_log_b8_p8.jpg')
imwrite(sum(abs(log_b-T), 3), 'Result\1a_log_b8_p16.jpg')
imwrite(sum(abs(log_c-T), 3), 'Result\1a_log_b16_p8.jpg')
imwrite(sum(abs(log_d-T), 3), 'Result\1a_log_b16_p16.jpg')
