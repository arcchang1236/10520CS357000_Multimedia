...
%% Mouse input
xlabel ('Select 99 points along the outline', 'FontName', 'Arial', 'FontSize', 14);
...
imwrite(result, 'result_100_low.png');

LoD = 0.01;
outlineVertexList = myBezier(ctrlPointList, clickedN, LoD); %Enrich outlineVertexList
figure;
result = drawAndFillPolygon( rbImage, ctrlPointList, outlineVertexList, true, true, true );
imwrite(result, 'result_100_high.png');
...
imwrite(result, 'result_100_NN.png');
